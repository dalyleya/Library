...
CREATE TABLE taken_books (
                             book_id INT,
                             subscriber_id INT,
                             PRIMARY KEY (book_id, subscriber_id),
...
VALUES('Women Who Run With the Wolves: Myths and Stories of the Wild Woman Archetype ', 'Clarissa Pinkola Estes', 2, 0);
...
ALTER TABLE taken_books OWNER TO postgres;
